  ...
  return (
    <Sidebar collapsible="icon" className="border-r-0">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, oklch(0.165 0.032 250) 0%, oklch(0.130 0.028 250) 100%)",
        }}
      >
        {/* Logo */}
        {!collapsed && (
          <div
            className="flex flex-col items-center justify-center gap-2 px-4 py-3 shrink-0"
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-[9px] text-sidebar-foreground/50 tracking-widest uppercase">
                Preventivas
              </p>
            </div>
          </div>
